...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, n_output=100):
        super().__init__()
        ...
        self.fc = nn.Linear(512 * block.expansion, n_output)
...
def resnet1d18(n_output):
    """ return a ResNet 18 object
    """
    return ResNet(BasicBlock, [2, 2, 2, 2], n_output)

def resnet1d34(n_output):
    """ return a ResNet 34 object
    """
    return ResNet(BasicBlock, [3, 4, 6, 3], n_output)

def resnet1d50(n_output):
    """ return a ResNet 50 object
    """
    return ResNet(BottleNeck, [3, 4, 6, 3], n_output)

def resnet1d101(n_output):
    """ return a ResNet 101 object
    """
    return ResNet(BottleNeck, [3, 4, 23, 3], n_output)

def resnet1d152(n_output):
    """ return a ResNet 152 object
    """
    return ResNet(BottleNeck, [3, 8, 36, 3], n_output)